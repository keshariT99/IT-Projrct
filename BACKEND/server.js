...
const packageRouter = require("./routes/packages.js") //get access model file
const adminpackageRouter = require("./routes/admin.js")

app.use("/package",packageRouter); //load js file
